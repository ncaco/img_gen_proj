...
import { listFlowCharacters, getFlowCharacter, generateFlowCards, listFlowCards, type FlowCharacter, type FlowCharacterDetail, type FlowCard } from '@/app/lib/flow';
...
export default function EncyclopediaSidebar({ isOpen, onClose, onUpdateNodes }: EncyclopediaSidebarProps) {
                  ...
                  {characterDetailLoading ? (
                    ...
                    <div className="py-2 space-y-2 text-xs text-white/80">
                      ...
                      {selectedCharacterDetail.iconicWeaponsOrSymbols.length > 0 && (
                        <div>
                          <div className="text-white/60 mb-1">전투/보구</div>
                          <div className="pl-2">
